""" This code is for tied linear autoencoders with bias vectors.
	Call with

	python tied_bias_linear_autoencoder [num_compressed_features num_steps \
...
y_dict = auto.linear_auto_encoder_arch(parameter['num_initial_features'], 
